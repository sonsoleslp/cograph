...
**cograph** is a modern R package for network visualization with rich node styling, multiple layouts, and first-class support for Transition Network Analysis (TNA).
...
Sophisticated visualization: hexagon nodes with precision donut + probability pie.
