...
publication-ready network plots from adjacency matrices, edge lists, or
igraph objects using a pipe-friendly API with full control over nodes,
edges, layouts, and themes.
