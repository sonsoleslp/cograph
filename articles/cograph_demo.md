...
We create a directed, row-normalized transition matrix with
self-regulation style state labels typical of TNA (Transition Network
Analysis).
...
![Spring layout with edge
weights](cograph_demo_files/figure-html/basic-splot-spring-1.png)
...
![Circle
layout](cograph_demo_files/figure-html/basic-splot-circle-1.png)
...
![soplot() with grid
graphics](cograph_demo_files/figure-html/basic-soplot-1.png)

soplot() with grid graphics
...
![All 10 node shapes](cograph_demo_files/figure-html/node-shapes-1.png)
...
![Curved edges with dashed starts and weights
shown](cograph_demo_files/figure-html/edge-styling-1.png)
...
![Confidence interval
underlays](cograph_demo_files/figure-html/edge-ci-1.png)
...
![Pie chart nodes with 4 segments
each](cograph_demo_files/figure-html/pie-basic-1.png)
...
![Pie nodes with 2-6 segments per
node](cograph_demo_files/figure-html/pie-varying-1.png)
...
![Styled pie nodes on dark
theme](cograph_demo_files/figure-html/pie-styled-1.png)
...
![Pie nodes with different color palettes per
node](cograph_demo_files/figure-html/pie-per-node-colors-1.png)
...
![Donut nodes with random fill proportions and
weights](cograph_demo_files/figure-html/donut-simple-1.png)

Donut nodes with random fill proportions and weights

## 7. Segmented Donut Nodes

Multi-segment donuts using `donut_values` (list of segment vectors) and
`donut_colors`.
...
![Segmented donut nodes with 3 categories
each](cograph_demo_files/figure-html/donut-segmented-1.png)
...
![Segmented donuts with different color palettes per
node](cograph_demo_files/figure-html/donut-per-node-colors-1.png)
...
![Donut rings with different polygon
shapes](cograph_demo_files/figure-html/donut-polygon-1.png)
...
![Donut nodes showing fill
percentages](cograph_demo_files/figure-html/donut-values-1.png)
...
![Donut ring with inner pie
segments](cograph_demo_files/figure-html/donut-pie-combo-1.png)
...
![Segmented outer donut with inner pie, per-node
colors](cograph_demo_files/figure-html/donut-pie-multi-1.png)
...
![Donut + pie combo on dark theme with
weights](cograph_demo_files/figure-html/donut-pie-dark-1.png)

Donut + pie combo on dark theme with weights
...
![Double donut: outer and inner progress
rings](cograph_demo_files/figure-html/double-donut-1.png)
...
![Segmented double donut with per-node
colors](cograph_demo_files/figure-html/double-donut-segmented-1.png)
...
![Triple layer: outer donut + inner donut + center
pie](cograph_demo_files/figure-html/triple-layer-1.png)
...
![Double donut with hexagon
shape](cograph_demo_files/figure-html/double-donut-polygon-1.png)
...
![](cograph_demo_files/figure-html/themes-1.png)![](cograph_demo_files/figure-html/themes-2.png)![](cograph_demo_files/figure-html/themes-3.png)![](cograph_demo_files/figure-html/themes-4.png)![](cograph_demo_files/figure-html/themes-5.png)![](cograph_demo_files/figure-html/themes-6.png)![](cograph_demo_files/figure-html/themes-7.png)
...
![Weights rounded to 1 digit with
labels](cograph_demo_files/figure-html/weight-digits-1.png)

Weights rounded to 1 digit with labels
...
![Threshold: only edges \>=
0.1](cograph_demo_files/figure-html/weight-threshold-1.png)

Threshold: only edges \>= 0.1
...
![Logarithmic edge
scaling](cograph_demo_files/figure-html/weight-scale-log-1.png)
...
![Edge labels showing
estimates](cograph_demo_files/figure-html/edge-labels-estimate-1.png)
...
![Custom label template with significance
stars](cograph_demo_files/figure-html/edge-labels-template-1.png)
...
![Directed with reciprocal curves and
weights](cograph_demo_files/figure-html/directed-1.png)
...
![Undirected
(symmetric)](cograph_demo_files/figure-html/undirected-1.png)
...
![Legend with groups and edge
colors](cograph_demo_files/figure-html/legends-1.png)
...
[`from_tna()`](http://sonsoles.me/cograph/reference/from_tna.md) output.
...
![TNA-style: donut fills represent initial state
probabilities](cograph_demo_files/figure-html/tna-style-1.png)
