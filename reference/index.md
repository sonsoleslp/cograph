...
Reshaping a network: selecting, thresholding, restructuring and editing.
Every verb takes any supported input and returns a cograph_network.
...
- [`sn_save()`](https://sonsoles.me/cograph/reference/sn_save.md) : Save
  Network Visualization
- [`aes-nodes`](https://sonsoles.me/cograph/reference/aes-nodes.md) :
  Node Aesthetics
- [`aes-edges`](https://sonsoles.me/cograph/reference/aes-edges.md) :
  Edge Aesthetics
- [`output-save`](https://sonsoles.me/cograph/reference/output-save.md)
  : Output and Saving
...
- [`layout-circle`](https://sonsoles.me/cograph/reference/layout-circle.md)
  : Circular Layout
- [`layout-groups`](https://sonsoles.me/cograph/reference/layout-groups.md)
  : Group-based Layout
- [`layout-oval`](https://sonsoles.me/cograph/reference/layout-oval.md)
  : Oval/Ellipse Layout
- [`layout-spring`](https://sonsoles.me/cograph/reference/layout-spring.md)
...
- [`coding`](https://sonsoles.me/cograph/reference/hai_datasets.md)
  ...
  [`ai_detailed`](https://sonsoles.me/cograph/reference/hai_datasets.md)
