---
title: "Sonnet: Complete Feature Demo"
...
```{r load-package}
# Load the development version from the project root
devtools::load_all(rprojroot::find_root(rprojroot::has_file("DESCRIPTION")))
```

# Demo Data: 10-Node Transition Matrix
...
*Generated with Sonnet `r packageVersion("Sonnet")`*
